// 2. С экрана вводится количество чисел и сами числа. Найти наибольшее число и вывести его на экран.
// Выполнить задание без накопления вводимых данных (без использования массивов, векторов и т.д.).
